...
export const FullBlog = (props: FullBlogProps) => {
  ...
  useEffect(() => {
    ...
    setStaleBlog(props.blog), dispatch2(setPreview(true));
  }, []);
  return (
    <div className="w-full h-full pt-15 relative" ref={parentRef}>
        ...
        {props.authorOrNot && (
          <div className="flex gap-2">
            ...
            <Button
              disableButton={
                isUpdating === "pending" ||
                JSON.stringify(props.blog) === JSON.stringify(staleBlog)
              }
      ...
      <div
        className={`${isProfileOpen ? "visible" : "invisible"} top-10 right-2`}
      >
        <UserProfile
          setProfileOpen={setProfileOpen}
          isProfileOpen={isProfileOpen}
          authorId={props.authorDetails.authorId}
        />
      </div>
      {/* Editor */}
      <div className="relative w-full">
        <MainEditor blog={props.blog} editor={editor} />

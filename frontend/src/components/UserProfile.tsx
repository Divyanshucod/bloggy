        ...
        <div className="mb-6">
          ...
          {editingBio ? (
            ...
            <p className="text-sm text-gray-600 mt-1">
              {isFetchingUserDeatils ? (
                <Skeleton variant="text" sx={{ fontSize: "1rem" }} />
              ) : !userDetails.bio || userDetails?.bio?.length === 0 ? (
                "No bio found"
              ) : (
                userDetails.bio
              )}
        ...
        <div className="mt-18 fixed top-0 right-0 w-full md:w-[400px] min-h-screen bg-white dark:bg-gray-900 shadow-lg z-50 overflow-y-auto transition-all">
          {isFetchingList ? (
            ...
            <>
              ...
              {showPanel === "followers" &&
              followers_following.followers.length == 0 ? (
                <div className="dark:text-white text-center">
                  No followers found
                </div>
              ) : showPanel === "following" &&
                followers_following.following.length == 0 ? (
                <div className="dark:text-white font-serif text-center">
                  No following found
                </div>
              ) : (
                <ul className="">

...
export const Button = ({
  ...
  const colorClasses = {
    cancel:
      "px-4 py-2 text-sm font-medium rounded-md bg-gray-300 text-gray-800 hover:bg-gray-400 dark:bg-gray-700 dark:text-gray-100 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 transition",
    primary:
  ...
  const disabledClasses = disableButton ? "opacity-50 cursor-not-allowed" : "";
